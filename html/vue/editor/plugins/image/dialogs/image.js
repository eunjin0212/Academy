    ...
    return {
      ...
      onOk: function () {
        if (this.imageEditMode) {
          ...
          "image" == k ? (this.imageElement = d.document.createElement("img")) : ((this.imageElement = d.document.createElement("input")), this.imageElement.setAttribute("type", "image")),
                      ...
                      children: [
                        {
                          ...
                          commit: function (a, b) {
                            ...
                            1 == a || 4 == a
                              ? (isNaN(c) ? !c && this.isChanged() && b.removeStyle("border") : (b.setStyle("border-width", CKEDITOR.tools.cssLength(c)), b.setStyle("border-style", "solid")),
                  ...
                  children: [
                    {
                      ...
                      html:
                        ...
                        (d.config.image_previewText || "이미지 미리보기") +
