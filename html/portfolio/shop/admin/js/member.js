...
function dataFunc(datas) {
  ...
  Object.keys(
    dataArr.map((i, j) => {
      ...
      }</td><td><input type='checkbox' value='Y' /></td><td><input type='checkbox' id='mail_agree${idx}' value='Y' /></td><td><input type='checkbox' id='sms_agree${idx}' value='Y' /></td><td><input type='checkbox' value='Y' /></td><td><input type='checkbox' value='Y' /></td><td id='user_tel${idx}'>${
        dataArr[j]['user_tel']
