...
*/
  ...
  function Datepicker() {
    ...
    this.regional[""] = {
      ...
      dayNamesShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], // 주를 표시
      dayNamesMin: ["일", "월", "화", "수", "목", "금", "토 "], // 주를 표시
      weekHeader: "Wk", // Column header for week of the year
      dateFormat: "yy년 mm월 dd일", // See format options on parseDate
      firstDay: 1, // 일요일(0), 월요일(1)...토요일(6)
      isRTL: false, // True if right-to-left language, false if left-to-right
      showMonthAfterYear: true, // 년월 출력 순서 변경
    ...
    this._defaults = {
      ...
      showAnim: "slideDown", // fadeIn, slideDown, show
      ...
      yearRange: "c-10:c+10", // c-10 해당 년도 이전 년도 -10까지 c+10 해당 년도 이후 + 10
